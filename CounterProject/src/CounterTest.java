...
class CounterTest {
	...
	void setUp() throws Exception {
		this.counter = new Counter(); //initialise counter before every test method
	}
	...
	void testIncrement() {
		...
		assertFalse(this.counter.getCount() == 2, "should not return 2 after callinig increment a third time.");
