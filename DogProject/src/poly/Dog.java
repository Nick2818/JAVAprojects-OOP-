...
public class Dog {
	...
	/**
	 * Creates a dog with given name, age, owner, and wieght.
	 * @param name of dog
	 * @param age of dog
	 * @param owner of dog
	 * @param weight of dog
	...
	public double eat(String amount) {
		...
		try {
			...
			System.out.println(amount + ": cant' be parsed as double.");
		}
		return returnVal;
	}
	...
	public void bark(String barkSound, int numTimes) {
		...
		//calls first bark method with given number of times and given bark sound
	...
	public static void main(String[] args) {
		...
		//print dogs
		//call the toStirng method in the Dog class
		...
		//call second eat method with int
		//print new weight
