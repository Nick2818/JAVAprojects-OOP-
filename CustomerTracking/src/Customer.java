...
/**
 * Represent a customer with a name, ID, and geography.
 * @author musur
 *
 */
public class Customer {
	...
	/**
	 * Returns Id, name of customer, company, and geography.
	 */
	...
	public static int findCustomer(Customer customer) {
		...
		for(int i = 0; i < Customer.CUSTOMERS.size(); i++) {
			if(Customer.CUSTOMERS.get(i).equals(customer)) { //thiw will call equals method in customer class
				index = i;
				break;
			}
	...
	public static void removeCustomer(Customer customer) {
		...
		//check if index is valid than remove customer
		if(removeIndex >= 0) {
	...
	public static void main(String[] args) {
		...
		//initialise the counter for generating unique IDs for each customer
		...
		//create customer
		Customer c3 = new Customer("Jeffry", "Australia");
