...
class ArrayAndArrayListTest {
	...
	void testHowMany() {
		...
		assertNotEquals(1, this.myArrayAndArrayList.howMany(array, 1));

		assertEquals(2, this.myArrayAndArrayList.howMany(array, 3));

		assertNotEquals(1, this.myArrayAndArrayList.howMany(array, 3));
	...
	void testFindMax() {
		...
		int[] array2 = {1, 3, 5, 7, 9, 1, 2, 3, 4, 5, 20};

		assertNotEquals(9, this.myArrayAndArrayList.findMax(array2));

		assertNotNull(this.myArrayAndArrayList.findMax(array2));

		assertEquals(20, this.myArrayAndArrayList.findMax(array2));
	...
	void testMaxArray() {
		...
		int[] array3 = {1, 3, 5, 7, 9, 1, 9, 2, 3, 4, 5, 9};
		testArrayList.add(9);
	...
	void testSwapZero() {
		...
		int[] array2 = {0, 1, 0, 2, 0, 3, 0, 5, 6, 7};
		int[] testArray2 = {1, 2, 3, 5, 6, 7, 0, 0, 0, 0};
		this.myArrayAndArrayList.swapZero(array2);

		assertArrayEquals(testArray2, array2);
		
		int[] array3 = {0, 0, 1, 0, 2, 0, 3, 0, 5, 6, 7};
		int[] testArray3 = {1, 2, 3, 5, 6, 7, 0, 0, 0, 0, 0};
		this.myArrayAndArrayList.swapZero(array3);

		assertArrayEquals(testArray3, array3);

		int[] array4 = {0, 0, 1, 0, 2, 0, 3, 0, 5, 6, 7, 9, 10};
		int[] testArray4 = {1, 2, 3, 5, 6, 7, 9, 10, 0, 0, 0, 0, 0};
